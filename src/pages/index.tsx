  ...
  return (
    <>
      <main className="">
        ...
        <Image className='' src={'https://media.discordapp.net/attachments/1093520927960092772/1095372282492362912/base_img_white_bg_red_bar.png?width=1440&height=338'} fill alt={'asbanner1'}/>
